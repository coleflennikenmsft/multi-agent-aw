...
class TesterExecutor(Executor):
    ...
    - If tests fail, sends feedback back to the implementer (looping).
    - If tests pass, forwards results to the reviewer.
    """
...
def build_workflow(client: CopilotClient):
    ...
    workflow = (
        ...
        .add_edge(tester, implementer)    # loop back on test failure
